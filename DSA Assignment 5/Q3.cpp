...
class List{
    ...
    void mid_elem(){
        if(!head){cout << "Empty list." << endl;}
        else if(!head->next){cout << "Middle element is: " << head->data << endl;}
        else{
            Node* slow = head;
            Node* fast = head;
            Node* pre;
            ...
            if(!fast){cout << "Middle elements are: " << pre->data << "\t" << slow->data << endl;}
            else{cout << "Middle element is: " << slow->data << endl;}
        }
    }
